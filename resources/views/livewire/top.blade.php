<div>
    <!-- ヒーローセクション -->
    <section
        class="bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-16 md:py-24 px-4 overflow-hidden relative">
        <!-- 背景の装飾要素 -->
        ...
        <!-- 波形の装飾（下部） -->
        <div class="absolute bottom-0 left-0 w-full overflow-hidden leading-0 transform"
